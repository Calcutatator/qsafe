  ...
  "cores": [
    {
      ...
      "subsections": [
        ...
        },
        {
          ...
          "what_it_is": "Human-readable names and portable identities bound to an account — ENS names, decentralized identifiers (DIDs), and verifiable credentials.",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "A smart contract that checks a signature before acting — token approvals and gasless permits (ecrecover, EIP-712) and N-of-M multisig wallets like Safe.",
        ...
        },
        {
          ...
          "what_it_is": "On-chain randomness that ships with a proof it wasn't tampered with — verifiable random functions (VRFs) and threshold randomness beacons like drand.",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "Whoever decides the order of transactions in a block — an L2 sequencer, or the elected leader/proposer on an L1 — and signs off on the resulting batch.",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "The signed votes validators cast to agree on blocks and mark them final — block proposals plus finality-gadget votes (Ethereum FFG = BLS, Polkadot GRANDPA = Ed25519, BEEFY = ECDSA).",
        ...
        },
        {
          ...
          "what_it_is": "Off-chain or conditional transfers settled by cryptographic conditions — payment channels (Lightning / HTLCs), adaptor signatures, and cross-chain atomic swaps.",
        ...
        },
        {
          ...
          "what_it_is": "The market that builds blocks on a proposer's behalf — relays and builders whose signed commitments are trusted to deliver and pay for a block (MEV-Boost, PBS).",
    ...
    },
    {
      ...
      "subsections": [
        ...
        },
        {
          ...
          "what_it_is": "The connections wallets and dapps use to reach the chain — HTTPS/TLS to RPC providers and relays like WalletConnect.",
