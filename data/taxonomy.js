window.TAXONOMY = {
  "meta": {
    ...
    "lens": {
      "signatures": "Broken by Shor (ECDSA, EdDSA, Schnorr, sr25519, BLS). Fix: ML-DSA / SLH-DSA / FN-DSA.",
      "encryption": "Broken by Shor (RSA, ECDH, TLS, IBE); harvest-now-decrypt-later. Fix: ML-KEM.",
      "pairings": "Pairing-based crypto (BLS, KZG) broken by Shor. The single most common root cause.",
      "hash": "Only weakened by Grover (quadratic, barely parallelizes). 256-bit hashes stay safe.",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "The user's private key that signs transactions.",
        ...
        },
        {
          ...
          "what_it_is": "Self-custody, hardware wallet, HSM, or exchange.",
        ...
        },
        {
          ...
          "what_it_is": "Distributed signers jointly produce a single signature.",
        ...
        },
        {
          ...
          "what_it_is": "Accounts whose verification logic is code (ERC-4337, native AA).",
        ...
        },
        {
          ...
          "what_it_is": "WebAuthn passkeys (secp256r1) and short-lived session keys.",
        ...
        },
        {
          ...
          "what_it_is": "ENS, DIDs, verifiable credentials.",
        ...
        },
        {
          ...
          "what_it_is": "On-chain votes/delegations and off-chain signed messages (Snapshot).",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "On-chain ECDSA checks (ecrecover, EIP-712 permits/approvals) and N-of-M multisig contracts.",
        ...
        },
        {
          ...
          "what_it_is": "EVM pairing precompiles (BN254, BLS12-381) and Groth16/PLONK-KZG verifier contracts.",
        ...
        },
        {
          ...
          "what_it_is": "Price/data feeds signed by operators (e.g., Chainlink OCR).",
        ...
        },
        {
          ...
          "what_it_is": "VRFs (EC-based) and threshold beacons (drand = threshold BLS).",
        ...
        },
        {
          ...
          "what_it_is": "Verifiable delay functions.",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "An L2 sequencer or L1 leader/proposer orders and usually signs the batch.",
        ...
        },
        {
          ...
          "what_it_is": "Validity/fraud proofs of state transitions.",
        ...
        },
        {
          ...
          "what_it_is": "Powers-of-tau / KZG structured reference string.",
        ...
        },
        {
          ...
          "what_it_is": "The commitment letting anyone reconstruct state.",
        ...
        },
        {
          ...
          "what_it_is": "The virtual machine executing logic.",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "Validator votes/attestations, finality-gadget votes (FFG=BLS, GRANDPA=Ed25519, BEEFY=ECDSA), proposer auth.",
        ...
        },
        {
          ...
          "what_it_is": "A small signing set whose headers light clients trust (Ethereum sync committee = BLS).",
        ...
        },
        {
          ...
          "what_it_is": "The L2's canonical bridge: L1 verifier contract + operator authorization.",
        ...
        },
        {
          ...
          "what_it_is": "External committees/MPC (Wormhole, LayerZero) or light-client verification (IBC).",
        ...
        },
        {
          ...
          "what_it_is": "Operators (EigenLayer, Symbiotic) sign attestations securing off-chain services, usually BLS.",
        ...
        },
        {
          ...
          "what_it_is": "HTLCs/Lightning, adaptor signatures, atomic swaps.",
        ...
        },
        {
          ...
          "what_it_is": "MEV-Boost relays, builder/proposer commitments.",
      ...
      "subsections": [
        {
          ...
          "what_it_is": "TLS / QUIC / Noise gossip channels.",
        ...
        },
        {
          ...
          "what_it_is": "libp2p peer IDs, validator network identity.",
        ...
        },
        {
          ...
          "what_it_is": "HTTPS/TLS to RPC providers, WalletConnect relays.",
        ...
        },
        {
          ...
          "what_it_is": "ECDH-based stealth addresses (ERC-5564) and similar key agreement.",
        ...
        },
        {
          ...
          "what_it_is": "Encrypted mempools (Shutter = pairing IBE + DKG), privacy chains, off-chain encrypted stores.",
