(function () {
  ...
  function renderSummary() {
    ...
    var html =
      '<section class="intro">' +
        "<h1>qsafe</h1>" +
        '<p class="lede">qsafe is an open-source framework for quantum risk in cryptographically secured software. ' +
        "Quantum computers don’t break cryptography in one way; they affect specific cryptographic surfaces: " +
        "signatures, encryption, pairings, and hashing. qsafe maps those risks across " +
        "<strong>5 core sections</strong> and <strong>30 components</strong>, providing a transparent view into a project’s current quantum-safety status.</p>" +
